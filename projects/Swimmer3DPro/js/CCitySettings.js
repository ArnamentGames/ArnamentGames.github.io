function CCitySettings() {
    ...
    this.initValueToAddInEachLevelToCPU = function() {
        _aValueToAddInEachLevelToCPU.push({
            speed: 0,
            energy: 0
        });
        _aValueToAddInEachLevelToCPU.push({
    ...
    this.addCitiesStorage = function() {
        localStorage.setItem("SPro_RewardTaken", JSON.stringify(_aRewardTaken));
        localStorage.setItem("SPro_TimeSpent", JSON.stringify(_aTimeSpent));
        localStorage.setItem("SPro_RewardEarned", JSON.stringify(_aRewardEarned));
        localStorage.setItem("SPro_ArrivalsPosition", JSON.stringify(_aArrivalsPosition));
    };
    ...
    this.removeCitiesStorage = function() {
        ...
        localStorage.removeItem("SPro_RewardTaken");
        localStorage.removeItem("SPro_TimeSpent");
        localStorage.removeItem("SPro_RewardEarned");
        localStorage.removeItem("SPro_ArrivalsPosition");
    };

    this.getCitiesStorage = function() {
        _aRewardTaken = JSON.parse(localStorage.getItem("SPro_RewardTaken"));
        _aTimeSpent = JSON.parse(localStorage.getItem("SPro_TimeSpent"));
        _aRewardEarned = JSON.parse(localStorage.getItem("SPro_RewardEarned"));
        _aArrivalsPosition = JSON.parse(localStorage.getItem("SPro_ArrivalsPosition"));
    };
